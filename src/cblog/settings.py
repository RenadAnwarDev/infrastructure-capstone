...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/renad/capstone/username", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/renad/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'sda-capstone-rds.cd8gk2sge0na.eu-central-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'sdacapstone-renad-blog' # please enter your s3 bucket name

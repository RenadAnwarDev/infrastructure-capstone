...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/renad/capstone/username", WithDecryption=False)
    password_param = ssm.get_parameter(Name="/renad/capstone/password", WithDecryption=False)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'blog-app-db.cd8gk2sge0na.eu-central-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
